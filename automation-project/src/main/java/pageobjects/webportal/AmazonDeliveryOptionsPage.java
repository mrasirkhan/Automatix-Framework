...
public class AmazonDeliveryOptionsPage extends BaseClass
{
	
	/*	WebDriver driver;
	WebDriverWait wait;*/

	public AmazonDeliveryOptionsPage(WebDriver driver) throws InterruptedException
	{
/*		this.driver = driver;
	...
	public AmazonPaymentDetailsPage clickOnContinueButton() throws InterruptedException
	{
		wait.until(ExpectedConditions.elementToBeClickable(continueButton)).click();
		return new AmazonPaymentDetailsPage(getDriver());
	}
